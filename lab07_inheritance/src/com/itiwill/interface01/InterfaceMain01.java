package com.itiwill.interface01;

import com.itiwill.database.Database;
import com.itiwill.mysql.MysqlDatabase;
import com.itiwill.oracle.OracleDatabase;
 ...
 *   class 클래스이름 implements(구현하다) 인터페이스 {}
...
public class InterfaceMain01 {
	...
	public static void main(String[] args) {
		...
		// MysqlDatabase 객체를 생성하고 메서드를 이용
