...
public class ArrayMain01 {
	...
	public static void main(String[] args) {
		...
		// 배열(array): 같은 타입의 데이터를 여러개를 하나의 변수 이름으로 저장하기 위한 타입.
		...
		int[] scores = new int[3]; // int 타입 3개를 저장할 수 있는 배열. 모든 값은 0으로 초기화  int scores[] = new int[3];
		scores[0] = 3;
		scores[1] = 1;
		scores[2] = 10;
		System.out.println(scores[0]); // 배열 scores의 인덱스 0의 위치의 원소를 출력.
