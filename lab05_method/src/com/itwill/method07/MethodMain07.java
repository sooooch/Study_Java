...
public class MethodMain07 {
	...
	public static void main(String[] args) {
		// 가변길이 인수(variabl-length argument):
		...
		System.out.println(calculate("*",4, 6, 9));
	...
	/**
	 * calculate. op의 값이 "+"인 경우에는, 가변길이 인수 values의 합을 리턴 values가 없으면 0을 리턴 op의 값이
	 * "*"인 경우에는, 가변길이 인수 values의 곱을 리턴. values가 없으면 1을 리턴 op의 값이 "+"나 "*"가 아니면 0을
	 * 리턴.
	 * 
	 * @param op     연산자. "+" 또는 "*".
