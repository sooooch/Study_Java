...
// 객체를 생성하지 못하도록 작성 모든 메서드는 public static 작성
public class FileUtil {
	public static final String DATA_DIR = "data"; // 데이터 파일을 저장할 폴더 이름
	public static final String DATA_FILE = "contacrs.dat"; // 데이터 파일 이름
	...
	/**
	 * 연락처 데이터 파일을 저장하는 폴더가 생성되어 있지 않으면, 폴더를 새로 생성하고 File 타입 객체를 리턴 데이터 폴더가 이미 존재하면
	 * , 그 폴더의 file 객체를 리턴
	 * 
	 * 
	 * @return File객체
