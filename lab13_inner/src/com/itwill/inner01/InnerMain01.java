 ...
 *	     중첩 클래스(nested class)
 *	    
 *      멤버 내부 인터페이스는 static이어야만함  static은 생략
 *		
...
public class InnerMain01 {
	...
	public static void main(String[] args) {
		...
		// InnerCls 타입의 객체를 생성             // import 문 없을때
		OuterCls.InnerCls inner1 = outer1.new InnerCls(100);
		inner1.info();
		

		
		// 내부 클래스 이름을 import한 경우 노 스태틱
		InnerCls inner2 = outer1.new InnerCls(222);
		inner2.info();
		...
		EnclosingCls e = new EnclosingCls(1);
		System.out.println(e); // toString()
		
		
		// NestedCls 타입 객체 생성 스태틱
		EnclosingCls.NestedCls nested1 = new EnclosingCls.NestedCls(1);
		NestedCls nested2 = new NestedCls(2);
		nested1.info();
	}
