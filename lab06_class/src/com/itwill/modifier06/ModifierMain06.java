 ...
 * 
 * final 수식어
 * - 클래스, 클래스의 멤버(필드,생성자,메서드), 지역 변수에서 사용 가능
 * - final 의미:바꿀 수 없는
 ...
 *   (6) static 메서드는 static 필드와 메서드만 사용 가능
 * 
 */
public class ModifierMain06 {
	...
	public ModifierMain06(String 수창) {
		this.message = 수창;
	}
	...
	//	final int = 2 ; // final 필드는 값을 변경할 수 없음
	...
	//	app.message = ""; //-> final필드 객체 생성 이후에 값을 변경할 수 없음
