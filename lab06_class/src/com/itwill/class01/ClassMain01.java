...
/*
 * 객체지향 프로그래밍 언어(Object-Oriented Programing Language)
 * 절차지향 프로그래밍 언어(Procedural Programing Language)
 * 
...
public class ClassMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("length: " + s1.length());  //length(): 문자열 객체의 기능(메서드)
		System.out.println("concat: " + s1.concat("비가오네요..."));
